...
async function Questions() {
    ...
    if (answers.oprator === "Addition") {
        ...
        console.log(chalk.blueBright(`${answers.num1} x ${answers.num2} = ${answers.num1 * answers.num2} `));
    }
...
async function stargAgain() {
    do {
        ...
        var loopAgain = await inquirer.prompt({
            type: "input",
            name: "restart",
            message: chalk.yellowBright("Do you want to start again? Press y for Yes & n for No else program will be repeated"),
        });
